      ...
      <Card className="border-[#1e2235] bg-[#11131e] text-white transition-colors hover:border-[#2a2f4c] rounded-2xl overflow-hidden shadow-sm h-full font-sans">
        <CardContent className="p-5 flex flex-col justify-between h-full min-h-[140px]">
          <div className="flex items-center gap-4">
            {/* Icon Block */}
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-b from-[#1c2438] to-[#121625] border border-[#2d3a5e] flex items-center justify-center text-3xl shadow-inner">
              {icon}
            </div>
